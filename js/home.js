...
const allDogsContainer = document.getElementById('allDogsContainer');
...
function renderCartsGrid(cartList) {
...
function renderDogsGrid(dogList) {
    if (dogList.length === 0) {
        return `
            <div class="empty-state">
...
function viewProductDetails(id, source) {
